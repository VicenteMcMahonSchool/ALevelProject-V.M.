...
{
    TileMap &tileMap = gameObjects.getGameObjectOfType(TILE_MAP)->tileMap; // Made it a reference to avoid copying the tile map.
    ...
    if (tileMap.getTileAttributes(tiles.top).isCollisionDetectable && centrePosition.y < tileCentres.top.y + averageHeight)
    {
    ...
    else if (tileMap.getTileAttributes(tiles.topLeft).isCollisionDetectable && (centrePosition - tileCentres.topLeft).isYBiggerThanX() && centrePosition.y < tileCentres.top.y + averageHeight)
    {
    ...
    else if (tileMap.getTileAttributes(tiles.topRight).isCollisionDetectable && (tileCentres.topRight - centrePosition).isNegativeYBiggerThanX() && centrePosition.y < tileCentres.top.y + averageHeight)
    {
    ...
    if (tileMap.getTileAttributes(tiles.bottom).isCollisionDetectable && centrePosition.y > tileCentres.bottom.y - averageHeight)
    {
    ...
    else if (tileMap.getTileAttributes(tiles.bottomLeft).isCollisionDetectable && (centrePosition - tileCentres.bottomLeft).isNegativeYBiggerThanX() && centrePosition.y > tileCentres.bottom.y - averageHeight)
    {
        if (tileMap.getTileAttributes(tiles.bottomLeft).isCollidable)
            handleCollisionBottom(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
            onCollision((const unsigned char *)tiles.bottomLeft, onCollisionData);
    }
    else if (tileMap.getTileAttributes(tiles.bottomRight).isCollisionDetectable && (tileCentres.bottomRight - centrePosition).isYBiggerThanX() && centrePosition.y > tileCentres.bottom.y - averageHeight)
    {
        if (tileMap.getTileAttributes(tiles.bottomRight).isCollidable)
            handleCollisionBottom(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
            onCollision((const unsigned char *)tiles.bottomRight, onCollisionData);
    }

    if (tileMap.getTileAttributes(tiles.left).isCollisionDetectable && centrePosition.x < tileCentres.left.x + averageWidth)
    {
    ...
    else if (tileMap.getTileAttributes(tiles.topLeft).isCollisionDetectable && (centrePosition - tileCentres.topLeft).isXBiggerThanY() && centrePosition.x < tileCentres.left.x + averageWidth)
    {
        if (tileMap.getTileAttributes(tiles.topLeft).isCollidable)
            handleCollisionLeft(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
    ...
    else if (tileMap.getTileAttributes(tiles.bottomLeft).isCollisionDetectable && (centrePosition - tileCentres.bottomLeft).isYBiggerThanNegativeX() && centrePosition.x < tileCentres.left.x + averageWidth)
    {
        if (tileMap.getTileAttributes(tiles.bottomLeft).isCollidable)
            handleCollisionLeft(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
    ...
    if (tileMap.getTileAttributes(tiles.right).isCollisionDetectable && centrePosition.x > tileCentres.right.x - averageWidth)
    {
    ...
    else if (tileMap.getTileAttributes(tiles.topRight).isCollisionDetectable && (centrePosition - tileCentres.topRight).isNegativeYBiggerThanX() && centrePosition.x > tileCentres.right.x - averageWidth)
    {
        if (tileMap.getTileAttributes(tiles.topRight).isCollidable)
            handleCollisionRight(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
    ...
    else if (tileMap.getTileAttributes(tiles.bottomRight).isCollisionDetectable && (centrePosition - tileCentres.bottomRight).isYBiggerThanX() && centrePosition.x > tileCentres.right.x - averageWidth)
    {
        if (tileMap.getTileAttributes(tiles.bottomRight).isCollidable)
            handleCollisionRight(tileCentres, centrePosition, averageWidth, averageHeight);
        if (onCollision != NULL)
