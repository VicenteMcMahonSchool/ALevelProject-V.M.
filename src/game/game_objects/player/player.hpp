...
#define TIME_SCALE_EQUATION(value)                                             \
    exp(-pow(16 * value, log(log(2)) / log(2))) + 0.05

void playerHandleCollision(const /* TILE_TYPE */ unsigned char *tile,
                           void *movableRectangle);
